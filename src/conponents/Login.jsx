...
const Login = ({login,handleloginchange ,handlelogin ,falseuser }) => {
  return (
    ...
    <div>
      ...
      useername:<input className="rounded-2xl border border-white/10 bg-slate-950/70 px-3 py-2 text-sm text-white outline-none transition placeholder:text-slate-500 focus:border-violet-400" type="text" name="user" value={login.user} onChange={handleloginchange} />
